...
public class Napakalaki {
    ...
    public CombatResult developCombat(){
        ...
        if(combat == CombatResult.LoseAndConvert){
            Cultist cult = dealer.nextCultist();
            CultistPlayer PlayerCult = new CultistPlayer(currentPlayer,cult);
            
            //TODO creo que guay no?, hay que reemplazar el player por el cultist player en su posicion
            players.set(players.indexOf(currentPlayer), PlayerCult);
            
            currentPlayer = PlayerCult;
        }
